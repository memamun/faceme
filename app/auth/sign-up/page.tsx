  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.auth.signUp({
        ...
        password,
        options: {
          emailRedirectTo: process.env.NEXT_PUBLIC_DEV_SUPABASE_REDIRECT_URL || `${window.location.origin}/timeline`,
        },
      })
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <Card className="w-full">
            <CardHeader>
              ...
              <CardDescription>Start building your personal memory vault</CardDescription>
            </CardHeader>
            <CardContent>
